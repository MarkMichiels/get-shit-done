...
<!-- ============================================================
     CUSTOM SECTION: AxaBio Traceability & Documentation Sync
     Added: 2026-01-25
     Author: Mark Michiels (via Claude)

     WHY: AI-built code needs automated verification AND documentation.
     - Requirements in .planning/requirements/*.yaml checked against code/tests
     - FEATURES.md and COVERAGE.md auto-generated from analysis
     - README.md and CLAUDE.md auto-generated from .planning/ sources

     MERGE NOTE: When updating from upstream get-shit-done, preserve
     this section. It should remain between </state_updates> and
     <final_commit>. Also keep the git add commands for generated docs
     in the <final_commit> section.

     Generated files (NEVER edit manually):
     - .planning/FEATURES.md   ← from requirements/*.yaml + code analysis
     - .planning/COVERAGE.md   ← from requirements/*.yaml + test analysis
     - README.md               ← from PROJECT.md, ROADMAP.md
     - CLAUDE.md               ← from STATE.md, ROADMAP.md
     ============================================================ -->

<traceability_verification>
After STATE.md update, check for requirements-based verification:

```bash
ls .planning/requirements/*.yaml 2>/dev/null | wc -l
```

**If requirements exist (count > 0):**

1. **Analyze traceability:**
   - Read all `.planning/requirements/*.yaml`
   - Read modified files from this plan (from task commits)
   - Determine which requirements are now implemented/tested

2. **Update FEATURES.md:**

   Generate/update `.planning/FEATURES.md` with current status:

   ```markdown
   # Features

   *Auto-generated by GSD executor. Do not edit manually.*
   *Last updated: {timestamp}*

   ## Phase {N}: {Name}

   ### {REQ-ID}: {Title} {status_emoji}

   **Status:** {Planned | In Progress | Implemented | Verified}

   | Criterion | Status | Evidence |
   |-----------|--------|----------|
   | {AC-ID}: {description} | {emoji} | {file:line or test reference} |
...
3. **Update COVERAGE.md:**
   ...
   Generate/update `.planning/COVERAGE.md`:

   ```markdown
   # Requirement Coverage

   *Auto-generated by GSD executor.*
   *Last updated: {timestamp}*

   | Phase | Requirements | Implemented | Tested | Verified |
   |-------|-------------:|------------:|-------:|---------:|
   | 1     | {n}          | {n}         | {n}    | {n}      |
...
4. **Verify no regressions:**
   - Compare previous COVERAGE.md (if exists) with new
   - If coverage decreased: Add warning to output
   - Continue execution (don't block)

5. **Update README.md:**

   Read `.planning/PROJECT.md` and `.planning/ROADMAP.md`, generate `README.md`:

   ```markdown
   # {Project Name}

   *Generated from .planning/PROJECT.md. Do not edit manually.*
   *Last generated: {timestamp}*

   ## Overview

   {from PROJECT.md vision/summary section}

   ## Status

   {from ROADMAP.md - list completed phases with ✅, current phase with ◆}
   ...
   {from FEATURES.md - summarize implemented requirements}

   ## Tech Stack

   {from PROJECT.md or STATE.md}

   ## Development

   {static setup instructions from PROJECT.md}

   ## License

   {from PROJECT.md or default}
   ```

6. **Update CLAUDE.md:**

   Read `.planning/STATE.md` and `.planning/ROADMAP.md`, generate `CLAUDE.md`:

   ```markdown
   # CLAUDE.md - {Project Name}

   *Generated from .planning/STATE.md. Do not edit manually.*
   *Last generated: {timestamp}*

   ## Project Context

   {from PROJECT.md summary}

   ## Current State

   **Milestone:** {from STATE.md}
   **Phase:** {from STATE.md current position}
   **Status:** {from STATE.md}

   ## Key Decisions

   {from STATE.md accumulated context - decisions table}
   ...
   {from STATE.md or static list}

   ## Development Environment

   {setup commands from PROJECT.md}
   ```

**If no requirements:** Still generate README.md and CLAUDE.md (they use PROJECT.md/STATE.md).

**Note:** This analysis is performed by the executor (Claude), not an external tool.
The executor reads requirements and code, determines coverage semantically.
</traceability_verification>
...
# Generated documentation (always updated):
git add .planning/FEATURES.md 2>/dev/null || true
git add .planning/COVERAGE.md 2>/dev/null || true
...
- [ ] Traceability verified (if requirements exist)
- [ ] FEATURES.md and COVERAGE.md updated (if requirements exist)
- [ ] README.md regenerated from PROJECT.md/ROADMAP.md
- [ ] CLAUDE.md regenerated from STATE.md/ROADMAP.md
